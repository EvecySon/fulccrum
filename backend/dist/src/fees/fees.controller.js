...
const calculate_fees_dto_1 = require("./dto/calculate-fees.dto");
let FeesController = class FeesController {
    ...
    async calculateFees(dto) {
        return this.feesService.previewOrderFees(dto.businessId, dto.customerAddressId, dto.subtotal, dto.promoCode);
    }
};
...
], FeesController.prototype, "getSettings", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], FeesController.prototype, "updateSettings", null);
__decorate([
    (0, common_1.Post)('calculate'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [calculate_fees_dto_1.CalculateFeesDto]),
    __metadata("design:returntype", Promise)
