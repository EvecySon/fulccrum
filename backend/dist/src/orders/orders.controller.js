...
let OrdersController = class OrdersController {
    ...
    async updateOrderStatus(id, dto, req) {
        return this.ordersService.updateOrderStatus(id, dto, req.user.sub, req.user.role);
    }
    async getMyOrders(req, page, limit) {
        return this.ordersService.getCustomerOrders(req.user.sub, page ? parseInt(page) : 1, limit ? parseInt(limit) : 20);
    }
    async getDriverOrders(req, status) {
        return this.ordersService.getDriverOrders(req.user.sub, status);
    }
    async getBusinessOrders(businessId, page, limit) {
        return this.ordersService.getBusinessOrders(businessId, page ? parseInt(page) : 1, limit ? parseInt(limit) : 20);
    }
...
__decorate([
    (0, common_1.Get)('driver/assigned'),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], OrdersController.prototype, "getBusinessOrders", null);
__decorate([
