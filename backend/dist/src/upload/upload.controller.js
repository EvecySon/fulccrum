...
let UploadController = class UploadController {
    ...
    async uploadBusinessLogo(file, req) {
        if (!file) {
            throw new common_1.BadRequestException('No file uploaded');
        }
        return this.uploadService.updateBusinessLogo(req.user.sub, file);
    }
    async uploadBusinessCover(file, req) {
        if (!file) {
            throw new common_1.BadRequestException('No file uploaded');
        }
        return this.uploadService.updateBusinessCover(req.user.sub, file);
    }
    async getUserFiles(req, page, limit) {
        return this.uploadService.getUserFiles(req.user.sub, page ? parseInt(page) : 1, limit ? parseInt(limit) : 20);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], UploadController.prototype, "uploadBusinessLogo", null);
__decorate([
    (0, common_1.Post)('business/cover'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file')),
    __param(0, (0, common_1.UploadedFile)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], UploadController.prototype, "uploadBusinessCover", null);
__decorate([
