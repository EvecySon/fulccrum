...
export default function CourierPaymentSetupScreen({ navigation, route }: any) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.titleSection}>
        ...
        <Text style={styles.subtitle}>Set up your bank account to receive your delivery earnings</Text>
      </View>
      ...
      <View style={styles.feeCard}>
        ...
        <Text style={styles.feeDesc}>
          A one-time registration fee of <Text style={styles.feeBold}>₦10,000</Text> is required to activate your courier account. This covers background check and onboarding.
        </Text>
          ...
          <View style={styles.bankList}>
            {bankOptions.map((bank) => (
              ...
              >
                ...
                {bankName === bank && <Ionicons name="checkmark" size={18} color={colors.teal} />}
              </TouchableOpacity>
            ))}
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  bankOptionActive: { backgroundColor: colors.teal + '08' },
  bankOptionText: { fontSize: 14, color: colors.textPrimary },
  bankOptionTextActive: { fontWeight: '700', color: colors.teal },
  primaryBtn: {
