...
export default function CourierPaymentScreen({ navigation }: any) {
  ...
  const handlePayFee = async () => {
    ...
    setError('');
    try {
      await paymentAPI.initialize('registration-courier', 15000);
      setFeePaid(true);
    } catch (err: any) {
  ...
  const handleSubmit = () => {
    Alert.alert(
      'Submitted!',
      'Your documents and payment have been received. We\'ll review your application and notify you once approved.',
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subtitle}>A one-time fee to activate your courier account</Text>
        ...
        <View style={styles.feeCard}>
          <View style={styles.feeHeader}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.feeTitle}>Courier Registration</Text>
              <Text style={styles.feeDesc}>One-time activation fee</Text>
            </View>
            <Text style={styles.feeAmount}>₦10,000</Text>
          </View>
          <View style={styles.feeBenefits}>
            {[
              'Access to delivery requests',
        ...
        {[
          ...
          >
            <View style={[styles.payMethodIcon, paymentMethod === m.key && styles.payMethodIconActive]}>
              <Ionicons name={m.icon as any} size={20} color={paymentMethod === m.key ? colors.textWhite : colors.teal} />
            </View>
            <View style={{ flex: 1 }}>
          ...
          >
            {processing ? (
              ...
              <>
                ...
                <Text style={styles.payBtnText}>Pay ₦10,000</Text>
              </>
            )}
          </TouchableOpacity>
        )}
...
const styles = StyleSheet.create({
  ...
  feeCard: {
    backgroundColor: colors.teal + '06', borderRadius: 16, padding: 18,
    marginBottom: 24, borderWidth: 1, borderColor: colors.teal + '15',
  },
  feeHeader: {
    flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 14,
    paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: colors.teal + '10',
  },
  feeTitle: { fontSize: 16, fontWeight: '700', color: colors.textPrimary },
  feeDesc: { fontSize: 12, color: colors.textLight, marginTop: 2 },
  feeAmount: { fontSize: 22, fontWeight: '800', color: colors.teal },
  feeBenefits: { gap: 8 },
  ...
  payMethodCardActive: { borderColor: colors.teal, backgroundColor: colors.teal + '06' },
  payMethodIcon: {
    width: 42, height: 42, borderRadius: 12, backgroundColor: colors.teal + '12',
    justifyContent: 'center', alignItems: 'center',
  },
  payMethodIconActive: { backgroundColor: colors.teal },
